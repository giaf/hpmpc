...
void kernel_dgemm_pp_nt_4x4_lib4(int kmax, double *A, double *B, double *C, int ldc, int alg)
	...
	__m128d
		c_00_10, c_01_11, c_02_12, c_03_13, c_20_30, c_21_31, c_22_32, c_23_33,
		a_01, a_23,
		b_0, b_1, b_temp_0, b_temp_1;
	
	c_00_10 = _mm_setzero_pd();
	c_01_11 = _mm_setzero_pd();
	c_02_12 = _mm_setzero_pd();
	c_03_13 = _mm_setzero_pd();
	c_20_30 = _mm_setzero_pd();
	c_21_31 = _mm_setzero_pd();
	c_22_32 = _mm_setzero_pd();
	c_23_33 = _mm_setzero_pd();
	...
	for(; k<kmax-3; k+=4)
		...
		c_21_31 = _mm_add_pd( c_21_31, b_temp_1 );
		
		b_0 = _mm_loaddup_pd(&B[2]);
		b_1 = _mm_loaddup_pd(&B[3]);

		b_temp_0 = b_0;
		b_0 = _mm_mul_pd( a_01, b_0 );
		c_02_12 = _mm_add_pd( c_02_12, b_0 );
		b_temp_0 = _mm_mul_pd( a_23, b_temp_0 );
		c_22_32 = _mm_add_pd( c_22_32, b_temp_0 );

		b_temp_1 = b_1;
		b_1 = _mm_mul_pd( a_01, b_1 );
		c_03_13 = _mm_add_pd( c_03_13, b_1 );
		b_temp_1 = _mm_mul_pd( a_23, b_temp_1 );
		c_23_33 = _mm_add_pd( c_23_33, b_temp_1 );
