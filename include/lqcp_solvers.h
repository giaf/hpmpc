...
#ifdef BLASFEO
void d_back_ric_rec_trf_libstr(int N, int *nx, int *nu, int *nb, int **hidxb, int *ng, struct d_strmat *hsBAbt, struct d_strmat *hsRSQrq, struct d_strmat *hsDCt, struct d_strvec *hsQx, int fact_QN, struct d_strmat *hsL, struct d_strmat *hsLxt, struct d_strmat *hswork_mat);
#endif
#if defined(TREE_MPC)
#ifdef BLASFEO
