...
/*d_print_mat(1, nx+nu, hux[0], 1);*/
	...
	if(compute_pi)
		...
		dtrmv_u_n_lib(nx, hpL[1]+(nx+pad+ncl)*bs, cnl, &hux[1][nu], &work[0], 1); // TODO remove nu
...
void d_ric_trs_mhe(int nx, int nu, int N, double **hpBAbt, double **hpL, double **hq, double **hux, double *work, int compute_pi, double **hpi) // TODO
	{
