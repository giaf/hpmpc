...
// normal-transposed, 8x4 with data packed in 4
void kernel_dgemm_dtrmm_pp_nt_8x4_lib4(int kadd, double *A0, double *A1, double *B, double *C0_dummy, double *C1_dummy, double *D0, double *D1, int ldc, int alg_dummy)
	{
