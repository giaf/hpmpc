...
MPC_AUX_OBJS = ./mpc_solvers/c99/d_aux_ip_hard_lib4.o ./mpc_solvers/c99/d_res_ip_res_hard.o ./mpc_solvers/c99/d_aux_ip_soft_lib4.o #./mpc_solvers/c99/s_aux_ip_c99_lib4.o
endif
ifeq ($(TARGET), C99_4X4)
AUX_OBJS = ./auxiliary/d_aux_lib4.o ./auxiliary/d_aux_extern_depend_lib4.o #./auxiliary/s_aux_lib4.o
