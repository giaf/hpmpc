...
void kernel_dsyrk_dpotrf_nt_12x4_lib4(int km, int kn, int tri, int kadd, int ksub, double *Ap, int sdap, double *Bp, double *Am, int sdam, double *Bm, double *C, int sdc, double *D, int sdd, double *fact, int alg, int fast_rsqrt);
void kernel_dsyrk_dpotrf_nt_8x8_lib4(int km, int kn, int tri, int kadd, int ksub, double *Ap, int sdap, double *Bp, int sdbp, double *Am, int sdam, double *Bm, int sdbm, double *C, int sdc, double *D, int sdd, double *fact, int alg, int fast_rsqrt);
void kernel_dsyrk_dpotrf_nt_8x4_lib4(int km, int kn, int tri, int kadd, int ksub, double *Ap, int sdap, double *Bp, double *Am, int sdam, double *Bm, double *C, int sdc, double *D, int sdd, double *fact, int alg, int fast_rsqrt);
