...
LQCP_OBJS = ./lqcp_solvers/d_back_ric_rec.o ./lqcp_solvers/d_back_ric_rec_libstr.o ./lqcp_solvers/d_for_schur_rec.o ./lqcp_solvers/d_res.o ./lqcp_solvers/d_part_cond.o #./lqcp_solvers/s_ric_sv.o ./lqcp_solvers/s_res.o
