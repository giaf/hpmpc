...
void corner_spotrf_strsv_3x3_lib4(int kinv, float *A, int sda, int *info);
void corner_spotrf_strsv_2x2_lib4(int kinv, float *A, int sda, int *info);
void corner_spotrf_strsv_1x1_lib4(float *A, int sda, int *info);
