...
void d_res_ip_hard_mpc(int nx, int nu, int N, int nb, int ng, double **hpBAbt, double **hpQ, double **hq, double **hux, double **pDCt, double **hd, double **hpi, double **hlam, double **ht, double **hrq, double **hrb, double **hrd, double *mu);
