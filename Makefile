...
KERNEL_OBJS_SINGLE = ./kernel/neon/kernel_sgemm_neon_lib4.o ./kernel/neon/kernel_strmm_c99_lib4.o ./kernel/neon/kernel_strsm_c99_lib4.o ./kernel/neon/kernel_spotrf_c99_lib4.o ./kernel/neon/kernel_sgemv_c99_lib4.o ./kernel/neon/kernel_strmv_c99_lib4.o ./kernel/neon/kernel_strsv_c99_lib4.o ./kernel/neon/kernel_ssymv_c99_lib4.o ./kernel/neon/kernel_stran_c99_lib4.o 
BLAS_OBJS = ./blas/blas_d_lib4.o ./blas/blas_s_lib4.o
MPC_OBJS = ./mpc_solvers/d_ip_box.o ./mpc_solvers/dres_ip_box.o ./mpc_solvers/d_aux_ip_c99_lib4.o ./mpc_solvers/d_ip2_box.o #./mpc_solvers/s_ip_box.o ./mpc_solvers/s_ip2_box.o ./mpc_solvers/sres_ip_box.o
