...
KERNEL_OBJS_SINGLE = ./kernel/avx2/kernel_sgemm_avx2_lib8.o ./kernel/avx2/kernel_strmm_avx2_lib8.o ./kernel/avx2/kernel_strsm_avx2_lib8.o ./kernel/avx2/kernel_spotrf_avx2_lib8.o
