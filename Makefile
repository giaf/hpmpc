...
MPC_AUX_OBJS = ./mpc_solvers/avx/d_aux_ip_hard_lib4.o ./mpc_solvers/avx/d_res_ip_res_hard.o ./mpc_solvers/avx/d_aux_ip_hard_libstr.o ./mpc_solvers/avx/d_aux_tree_ip_hard_libstr.o ./mpc_solvers/avx/d_res_ip_res_hard_libstr.o #./mpc_solvers/avx/s_aux_ip_avx_lib8.o ./mpc_solvers/avx/d_aux_ip_soft_lib4.o
endif
ifeq ($(TARGET), X64_AVX)
AUX_OBJS = ./auxiliary/d_aux_lib4.o ./auxiliary/d_aux_extern_depend_lib4.o #./auxiliary/s_aux_lib8.o
...
MPC_AUX_OBJS = ./mpc_solvers/c99/d_aux_ip_hard_lib4.o ./mpc_solvers/c99/d_res_ip_res_hard.o ./mpc_solvers/c99/d_aux_ip_hard_libstr.o ./mpc_solvers/c99/d_res_ip_res_hard_libstr.o #./mpc_solvers/c99/s_aux_ip_c99_lib4.o ./mpc_solvers/c99/d_aux_ip_soft_lib4.o
endif
ifeq ($(TARGET), C99_4X4)
AUX_OBJS = ./auxiliary/d_aux_lib4.o ./auxiliary/d_aux_extern_depend_lib4.o #./auxiliary/s_aux_lib4.o
...
MPC_OBJS = $(MPC_AUX_OBJS) ./mpc_solvers/d_ip2_hard.o ./mpc_solvers/d_res_ip_hard.o ./mpc_solvers/d_ip2_res_hard.o ./mpc_solvers/d_ip2_res_hard_libstr.o ./mpc_solvers/d_tree_ip2_res_hard_libstr.o 
