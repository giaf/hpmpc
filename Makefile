...
ifeq ($(TARGET), X64_AVX_LIB8)
AUX_OBJS = ./auxiliary/aux_d_c99_lib4.o ./auxiliary/aux_s_c99.o ./auxiliary/block_size_x64_avx_lib8.o 
...
CFLAGS = $(OPT) -std=c99 -mavx -DTARGET_X64_AVX_LIB8 $(DEBUG)
endif
ifeq ($(TARGET), X64_AVX)
