...
************************************************/
		...
		// call the solver
		sricposv_mpc(nx, nu, N, hpBAbt, hpQ, hux, hpL, work, diag, COMPUTE_MULT, hpi);
		...
		sres(nx, nu, N, hpBAbt, hpQ, hq, hux, hpi, hrq, hrb);
		...
		// call the solver 
		sricpotrs_mpc(nx, nu, N, hpBAbt, hpL, hq, hux, work, COMPUTE_MULT, hpi);
