...
void d_update_hessian_mpc_hard_tv(int N, int const *nx, int const *nu, int const *nb, int const *ng, double **db, double sigma_mu, double **t, double **t_inv, double **lam, double **lamt, double **dlam, double **Qx, double **qx)
	{
...
void d_update_gradient_new_rhs_mpc_hard_tv(int N, int const *nx, int const *nu, int const *nb, int const *ng, double **db, double **lamt, double **qx)
	{
