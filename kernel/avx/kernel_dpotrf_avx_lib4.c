...
void kernel_dsyrk_dpotrf_nt_8x4_lib4_new(int kadd, int tri_A, double *Ap0, int sdap, double *Bp, int ksub, double *Am0, int sdam, double *Bm, int alg, double *C0, int sdc, int use_diag_C, double *diag_C, double *D0, int sdd, double *inv_diag_D)
	{
