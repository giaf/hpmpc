...
KERNEL_OBJS_SINGLE = ./kernel/avx2/kernel_sgemm_avx2_lib8.o
BLAS_OBJS = ./blas/blas_d_lib4.o ./blas/blas_s_lib8.o
MPC_OBJS = ./mpc_solvers/d_ip_box.o ./mpc_solvers/dres_ip_box.o ./mpc_solvers/d_aux_ip_avx_lib4.o ./mpc_solvers/d_ip2_box.o #./mpc_solvers/s_ip_box.o ./mpc_solvers/s_ip2_box.o ./mpc_solvers/sres_ip_box.o
...
MPC_OBJS = ./mpc_solvers/d_ip_box.o ./mpc_solvers/dres_ip_box.o ./mpc_solvers/d_aux_ip_c99_lib4.o ./mpc_solvers/d_ip2_box.o ./mpc_solvers/s_ip_box.o ./mpc_solvers/sres_ip_box.o ./mpc_solvers/s_aux_ip_c99_lib4.o ./mpc_solvers/s_ip2_box.o
