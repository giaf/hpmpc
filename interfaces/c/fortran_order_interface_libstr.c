...
//printf("\n%d\n", ((size_t) ptr) & 63);
	...
	for(ii=0; ii<N; ii++)
		{
		d_cvt_mat2strmat(nu[ii], nx[ii+1], B[ii], nu[ii], &hsBAbt[ii], 0, 0);
		d_cvt_mat2strmat(nx[ii], nx[ii+1], A[ii], nx[ii], &hsBAbt[ii], nu[ii], 0);
		d_cvt_tran_mat2strmat(nx[ii+1], 1, b[ii], nx[ii+1], &hsBAbt[ii], nu[ii]+nx[ii], 0);
		d_cvt_vec2strvec(nx[ii+1], b[ii], &hsb[ii], 0);
		}
#if 0
...
//	exit(1);
	...
	for(ii=0; ii<N; ii++)
		{
		d_cvt_mat2strmat(nu[ii], ng[ii], D[ii], nu[ii], &hsDCt[ii], 0, 0);
		d_cvt_mat2strmat(nx[ii], ng[ii], C[ii], nx[ii], &hsDCt[ii], nu[ii], 0);
		}
	ii = N;
	d_cvt_mat2strmat(nx[ii], ng[ii], C[ii], nx[ii], &hsDCt[ii], 0, 0);
#if 0
	for(ii=0; ii<=N; ii++)
		d_print_strmat(nu[ii]+nx[ii], ng[ii], &hsDCt[ii], 0, 0);
//	exit(1);
	...
	for(ii=0; ii<N; ii++)
		{
		d_cvt_tran_mat2strmat(nu[ii], nu[ii], R[ii], nu[ii], &hsRSQrq[ii], 0, 0);
		d_cvt_mat2strmat(nx[ii], nu[ii], S[ii], nx[ii], &hsRSQrq[ii], nu[ii], 0);
		d_cvt_tran_mat2strmat(nx[ii], nx[ii], Q[ii], nx[ii], &hsRSQrq[ii], nu[ii], nu[ii]);
		d_cvt_tran_mat2strmat(nu[ii], 1, r[ii], nu[ii], &hsRSQrq[ii], nu[ii]+nx[ii], 0);
		d_cvt_tran_mat2strmat(nx[ii], 1, q[ii], nx[ii], &hsRSQrq[ii], nu[ii]+nx[ii], nu[ii]);
		d_cvt_vec2strvec(nu[ii], r[ii], &hsrq[ii], 0);
		d_cvt_vec2strvec(nx[ii], q[ii], &hsrq[ii], nu[ii]);
	...
	ii = N;
	d_cvt_tran_mat2strmat(nx[ii], nx[ii], Q[ii], nx[ii], &hsRSQrq[ii], 0, 0);
	d_cvt_tran_mat2strmat(nx[ii], 1, q[ii], nx[ii], &hsRSQrq[ii], nx[ii], 0);
	d_cvt_vec2strvec(nx[ii], q[ii], &hsrq[ii], 0);
#if 0
	for(ii=0; ii<=N; ii++)
