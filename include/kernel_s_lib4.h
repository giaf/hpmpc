...
void kernel_sgemm_nt_12x4_lib4(int kmax, float *A0, float *A1, float *A2, float *B, float *C0, float *C1, float *C2, float *D0, float *D1, float *D2, int ldc, int alg);
void kernel_sgemm_nt_8x4_lib4(int kmax, float *A0, float *A1, float *B, float *C0, float *C1, float *D0, float *D1, int ldc, int alg);
void kernel_sgemm_nt_8x2_lib4(int kmax, float *A0, float *A1, float *B, float *C0, float *C1, float *D0, float *D1, int ldc, int alg);
void kernel_sgemm_nt_4x4_lib4(int kmax, float *A, float *B, float *C, float *D, int ldc, int alg);
...
void kernel_strmm_nt_12x4_lib4(int kadd, float *A0, float *A1, float *A2, float *B, float *D0, float *D1, float *D2, int ldc);
void kernel_strmm_nt_8x4_lib4(int kadd, float *A0, float *A1, float *B, float *D0, float *D1, int ldc);
void kernel_strmm_nt_4x4_lib4(int kadd, float *A, float *B, float *D, int ldc);
void kernel_ssyrk_spotrf_nt_12x4_lib4(int kadd, int ksub, float *A0, float *A1, float *A2, float *B, float *C0, float *C1, float *C2, float *D0, float *D1, float *D2, int ldc, float *fact);
void kernel_ssyrk_spotrf_nt_8x4_lib4(int kadd, int ksub, float *A0, float *A1, float *B, float *C0, float *C1, float *D0, float *D1, int ldc, float *fact);
...
void kernel_sgemm_strsm_nt_12x4_lib4(int kadd, int ksub, float *A0, float *A1, float *A2, float *B, float *C0, float *C1, float *C2, float *D0, float *D1, float *D2, int ldc, float *fact);
void kernel_sgemm_strsm_nt_8x4_lib4(int kadd, int ksub, float *A0, float *A1, float *B, float *C0, float *C1, float *D0, float *D1, int ldc, float *fact);
void kernel_sgemm_strsm_nt_8x2_lib4(int kadd, int ksub, float *A0, float *A1, float *B, float *C0, float *C1, float *D0, float *D1, int ldc, float *fact);
...
// corner
void corner_strmm_nt_8x3_lib4(float *A0, float *A1, float *B, float *C0, float *C1, int ldc);
void corner_strmm_nt_8x2_lib4(float *A0, float *A1, float *B, float *C0, float *C1, int ldc);
void corner_strmm_nt_8x1_lib4(float *A0, float *A1, float *B, float *C0, float *C1, int ldc);
