...
AUX_OBJS = ./auxiliary/aux_d_c99_lib4.o ./auxiliary/aux_s_c99_lib8.o #./auxiliary/block_size_x64_avx.o 
KERNEL_OBJS_DOUBLE = ./kernel/avx2/kernel_dgemm_avx2_lib4.o ./kernel/avx2/kernel_dtrmm_avx_lib4.o  ./kernel/avx2/kernel_dtrsm_avx_lib4.o ./kernel/avx2/kernel_dsyrk_avx_lib4.o  ./kernel/avx2/kernel_dpotrf_avx_lib4.o ./kernel/avx2/kernel_dgemv_avx_lib4.o ./kernel/avx2/kernel_dtrmv_avx_lib4.o ./kernel/avx2/kernel_dtrsv_avx_lib4.o ./kernel/avx2/kernel_dsymv_avx_lib4.o ./kernel/avx2/kernel_dtran_avx_lib4.o ./kernel/avx2/kernel_dttmm_c99_lib4.o ./kernel/avx2/kernel_dtrinv_c99_lib4.o 
...
AUX_OBJS = ./auxiliary/aux_d_c99_lib4.o ./auxiliary/aux_s_c99_lib4.o # ./auxiliary/block_size_cortex_a15.o
KERNEL_OBJS_DOUBLE = ./kernel/neon/kernel_dgemm_vfpv3_lib4.o ./kernel/neon/kernel_dtrmm_vfpv3_lib4.o  ./kernel/neon/kernel_dtrsm_vfpv3_lib4.o ./kernel/neon/kernel_dsyrk_vfpv3_lib4.o  ./kernel/neon/kernel_dpotrf_vfpv3_lib4.o ./kernel/neon/kernel_dgemv_c99_lib4.o ./kernel/neon/kernel_dtrmv_c99_lib4.o ./kernel/neon/kernel_dtrsv_c99_lib4.o ./kernel/neon/kernel_dsymv_c99_lib4.o ./kernel/neon/kernel_dtran_c99_lib4.o ./kernel/neon/kernel_dttmm_c99_lib4.o ./kernel/neon/kernel_dtrinv_c99_lib4.o 
...
LQCP_OBJS = $(LQCP_AUX_OBJS) ./lqcp_solvers/d_ric_sv.o ./lqcp_solvers/d_res.o ./lqcp_solvers/s_ric_sv.o ./lqcp_solvers/s_res.o
