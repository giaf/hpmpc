...
/*	printf("\nflush subnormals to zero\n");*/
	...
	printf("\n");
#if IP == 1
	printf(" IP method parameters: primal-dual IP, single precision, %d maximum iterations, %e exit tolerance in duality measure.\n", K_MAX, TOL);
#elif IP == 2
	printf(" IP method parameters: predictor-corrector IP, single precision, %d maximum iterations, %e exit tolerance in duality measure.\n", K_MAX, TOL);
#else
