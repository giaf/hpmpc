	...
	if(tc==0)
		...
		if(td==0) // not transpose D
			...
			for(; i<m-11; i+=12)
				...
				for(; j<n-3; j+=4)
					{
					kernel_dgemm_nn_12x4_lib4(k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, alg, 0, 0);
					}
				if(j<n)
					{
					if(n-j==3)
						{
						kernel_dgemm_nn_12x4_vs_lib4(12, 3, k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, alg, 0, 0);
						}
					else // n-j==1 || n-j==2
						{
						kernel_dgemm_nn_8x2_vs_lib4(8, n-j, k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, alg, 0, 0);
						kernel_dgemm_nn_4x2_vs_lib4(4, n-j, k, &pA[(i+8)*sda], &pB[j*bs], sdb, &pC[j*bs+(i+8)*sdc], &pD[j*bs+(i+8)*sdd], alg, 0, 0);
						}
					}
				}
			if(m-i<5)
			...
			for(; i<m-7; i+=8)
				...
				for(; j<n-3; j+=4)
					{
					kernel_dgemm_nn_8x4_lib4(k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, alg, 0, 0);
					}
				if(j<n)
					{
					if(n-j==3)
						{
						kernel_dgemm_nn_8x4_vs_lib4(8, 3, k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, alg, 0, 0);
						}
					else // n-j==1 || n-j==2
						{
						kernel_dgemm_nn_8x2_vs_lib4(8, n-j, k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, alg, 0, 0);
			...
			for(; j<n-2; j+=4)
				{
				kernel_dgemm_nn_12x4_vs_lib4(m-i, n-j, k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, alg, 0, 0);
				}
			if(j<n)
				{
				kernel_dgemm_nn_8x2_vs_lib4(m-i, n-j, k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, alg, 0, 0);
				kernel_dgemm_nn_4x2_vs_lib4(m-i-8, n-j, k, &pA[(i+8)*sda], &pB[j*bs], sdb, &pC[j*bs+(i+8)*sdc], &pD[j*bs+(i+8)*sdd], alg, 0, 0);
				}
			return;
#endif
			...
			for(; j<n-2; j+=4)
				{
				kernel_dgemm_nn_8x4_vs_lib4(m-i, n-j, k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, alg, 0, 0);
				}
			if(j<n)
				{
				kernel_dgemm_nn_8x2_vs_lib4(m-i, n-j, k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, alg, 0, 0);
			...
			for(; j<n-2; j+=4)
				{
				kernel_dgemm_nn_4x4_vs_lib4(m-i, n-j, k, &pA[i*sda], &pB[j*bs], sdb, &pC[j*bs+i*sdc], &pD[j*bs+i*sdd], alg, 0, 0);
				}
			if(j<n)
				{
				kernel_dgemm_nn_4x2_vs_lib4(m-i, n-j, k, &pA[i*sda], &pB[j*bs], sdb, &pC[j*bs+i*sdc], &pD[j*bs+i*sdd], alg, 0, 0);
				}
			return;
			...
			for(; i<m-11; i+=12)
				...
				for(; j<n-3; j+=4)
					{
					kernel_dgemm_nn_12x4_lib4(k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[j*bs+i*sdc], sdc, &pD[i*bs+j*sdd], sdd, alg, 0, 1);
					}
				if(j<n)
					{
					if(n-j==3)
						{
						kernel_dgemm_nn_12x4_vs_lib4(12, 3, k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[j*bs+i*sdc], sdc, &pD[i*bs+j*sdd], sdd, alg, 0, 1);
						}
					else // n-j==1 || n-j==2
						{
						kernel_dgemm_nn_8x2_vs_lib4(8, n-j, k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[j*bs+i*sdc], sdc, &pD[i*bs+j*sdd], sdd, alg, 0, 1);
						kernel_dgemm_nn_4x2_vs_lib4(4, n-j, k, &pA[(i+8)*sda], &pB[j*bs], sdb, &pC[j*bs+(i+8)*sdc], &pD[(i+8)*bs+j*sdd], alg, 0, 1);
						}
					}
				}
			if(m-i<5)
			...
			for(; i<m-7; i+=8)
				...
				for(; j<n-3; j+=4)
					{
					kernel_dgemm_nn_8x4_lib4(k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[j*bs+i*sdc], sdc, &pD[i*bs+j*sdd], sdd, alg, 0, 1);
					}
				if(j<n)
					{
					if(n-j==3)
						{
						kernel_dgemm_nn_8x4_vs_lib4(8, 3, k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[j*bs+i*sdc], sdc, &pD[i*bs+j*sdd], sdd, alg, 0, 1);
						}
					else // n-j==1 || n-j==2
						{
						kernel_dgemm_nn_8x2_vs_lib4(8, n-j, k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[j*bs+i*sdc], sdc, &pD[i*bs+j*sdd], sdd, alg, 0, 1);
			...
			for(; j<n-2; j+=4)
				{
				kernel_dgemm_nn_12x4_vs_lib4(m-i, n-j, k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[j*bs+i*sdc], sdc, &pD[i*bs+j*sdd], sdd, alg, 0, 1);
				}
			if(j<n)
				{
				kernel_dgemm_nn_8x2_vs_lib4(m-i, n-j, k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[j*bs+i*sdc], sdc, &pD[i*bs+j*sdd], sdd, alg, 0, 1);
				kernel_dgemm_nn_4x2_vs_lib4(m-i-8, n-j, k, &pA[(i+8)*sda], &pB[j*bs], sdb, &pC[j*bs+(i+8)*sdc], &pD[(i+8)*bs+j*sdd], alg, 0, 1);
				}
			return;
#endif
			...
			for(; j<n-2; j+=4)
				{
				kernel_dgemm_nn_8x4_vs_lib4(m-i, n-j, k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[j*bs+i*sdc], sdc, &pD[i*bs+j*sdd], sdd, alg, 0, 1);
				}
			if(j<n)
				{
				kernel_dgemm_nn_8x2_vs_lib4(m-i, n-j, k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[j*bs+i*sdc], sdc, &pD[i*bs+j*sdd], sdd, alg, 0, 1);
			...
			for(; j<n-2; j+=4)
				{
				kernel_dgemm_nn_4x4_vs_lib4(m-i, n-j, k, &pA[i*sda], &pB[j*bs], sdb, &pC[j*bs+i*sdc], &pD[i*bs+j*sdd], alg, 0, 1);
				}
			if(j<n)
				{
				kernel_dgemm_nn_4x2_vs_lib4(m-i, n-j, k, &pA[i*sda], &pB[j*bs], sdb, &pC[j*bs+i*sdc], &pD[i*bs+j*sdd], alg, 0, 1);
				}
			return;
		...
		if(td==0) // not transpose D
			...
			for(; i<m-11; i+=12)
				...
				for(; j<n-3; j+=4)
					{
					kernel_dgemm_nn_12x4_lib4(k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[i*bs+j*sdc], sdc, &pD[j*bs+i*sdd], sdd, alg, 1, 0);
					}
				if(j<n)
					{
					if(n-j==3)
						{
						kernel_dgemm_nn_12x4_vs_lib4(12, 3, k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[i*bs+j*sdc], sdc, &pD[j*bs+i*sdd], sdd, alg, 1, 0);
						}
					else // n-j==1 || n-j==2
						{
						kernel_dgemm_nn_8x2_vs_lib4(8, n-j, k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[i*bs+j*sdc], sdc, &pD[j*bs+i*sdd], sdd, alg, 1, 0);
						kernel_dgemm_nn_4x2_vs_lib4(4, n-j, k, &pA[(i+8)*sda], &pB[j*bs], sdb, &pC[(i+8)*bs+j*sdc], &pD[j*bs+(i+8)*sdd], alg, 1, 0);
						}
					}
				}
			if(m-i<5)
			...
			for(; i<m-7; i+=8)
				...
				for(; j<n-3; j+=4)
					{
					kernel_dgemm_nn_8x4_lib4(k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[i*bs+j*sdc], sdc, &pD[j*bs+i*sdd], sdd, alg, 1, 0);
					}
				if(j<n)
					{
					if(n-j==3)
						{
						kernel_dgemm_nn_8x4_vs_lib4(8, 3, k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[i*bs+j*sdc], sdc, &pD[j*bs+i*sdd], sdd, alg, 1, 0);
						}
					else // n-j==1 || n-j==2
						{
						kernel_dgemm_nn_8x2_vs_lib4(8, n-j, k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[i*bs+j*sdc], sdc, &pD[j*bs+i*sdd], sdd, alg, 1, 0);
			...
			for(; j<n-2; j+=4)
				{
				kernel_dgemm_nn_12x4_vs_lib4(m-i, n-j, k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[i*bs+j*sdc], sdc, &pD[j*bs+i*sdd], sdd, alg, 1, 0);
				}
			if(j<n)
				{
				kernel_dgemm_nn_8x2_vs_lib4(m-i, n-j, k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[i*bs+j*sdc], sdc, &pD[j*bs+i*sdd], sdd, alg, 1, 0);
				kernel_dgemm_nn_4x2_vs_lib4(m-i-8, n-j, k, &pA[(i+8)*sda], &pB[j*bs], sdb, &pC[(i+8)*bs+j*sdc], &pD[j*bs+(i+8)*sdd], alg, 1, 0);
				}
			return;
#endif
			...
			for(; j<n-2; j+=4)
				{
				kernel_dgemm_nn_8x4_vs_lib4(m-i, n-j, k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[i*bs+j*sdc], sdc, &pD[j*bs+i*sdd], sdd, alg, 1, 0);
				}
			if(j<n)
				{
				kernel_dgemm_nn_8x2_vs_lib4(m-i, n-j, k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[i*bs+j*sdc], sdc, &pD[j*bs+i*sdd], sdd, alg, 1, 0);
			...
			for(; j<n-2; j+=4)
				{
				kernel_dgemm_nn_4x4_vs_lib4(m-i, n-j, k, &pA[i*sda], &pB[j*bs], sdb, &pC[i*bs+j*sdc], &pD[j*bs+i*sdd], alg, 1, 0);
				}
			if(j<n)
				{
				kernel_dgemm_nn_4x2_vs_lib4(m-i, n-j, k, &pA[i*sda], &pB[j*bs], sdb, &pC[i*bs+j*sdc], &pD[j*bs+i*sdd], alg, 1, 0);
				}
			return;
			...
			for(; i<m-11; i+=12)
				...
				for(; j<n-3; j+=4)
					{
					kernel_dgemm_nn_12x4_lib4(k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[i*bs+j*sdc], sdc, &pD[i*bs+j*sdd], sdd, alg, 1, 1);
					}
				if(j<n)
					{
					if(n-j==3)
						{
						kernel_dgemm_nn_12x4_vs_lib4(12, 3, k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[i*bs+j*sdc], sdc, &pD[i*bs+j*sdd], sdd, alg, 1, 1);
						}
					else // n-j==1 || n-j==2
						{
						kernel_dgemm_nn_8x2_vs_lib4(8, n-j, k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[i*bs+j*sdc], sdc, &pD[i*bs+j*sdd], sdd, alg, 1, 1);
						kernel_dgemm_nn_4x2_vs_lib4(4, n-j, k, &pA[(i+8)*sda], &pB[j*bs], sdb, &pC[(i+8)*bs+j*sdc], &pD[(i+8)*bs+j*sdd], alg, 1, 1);
						}
					}
				}
			if(m-i<5)
			...
			for(; i<m-7; i+=8)
				...
				for(; j<n-3; j+=4)
					{
					kernel_dgemm_nn_8x4_lib4(k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[i*bs+j*sdc], sdc, &pD[i*bs+j*sdd], sdd, alg, 1, 1);
					}
				if(j<n)
					{
					if(n-j==3)
						{
						kernel_dgemm_nn_8x4_vs_lib4(8, 3, k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[i*bs+j*sdc], sdc, &pD[i*bs+j*sdd], sdd, alg, 1, 1);
						}
					else // n-j==1 || n-j==2
						{
						kernel_dgemm_nn_8x2_vs_lib4(8, n-j, k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[i*bs+j*sdc], sdc, &pD[i*bs+j*sdd], sdd, alg, 1, 1);
			...
			for(; j<n-2; j+=4)
				{
				kernel_dgemm_nn_12x4_vs_lib4(m-i, n-j, k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[i*bs+j*sdc], sdc, &pD[i*bs+j*sdd], sdd, alg, 1, 1);
				}
			if(j<n)
				{
				kernel_dgemm_nn_8x2_vs_lib4(m-i, n-j, k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[i*bs+j*sdc], sdc, &pD[i*bs+j*sdd], sdd, alg, 1, 1);
				kernel_dgemm_nn_4x2_vs_lib4(m-i-8, n-j, k, &pA[(i+8)*sda], &pB[j*bs], sdb, &pC[(i+8)*bs+j*sdc], &pD[(i+8)*bs+j*sdd], alg, 1, 1);
				}
			return;
#endif
			...
			for(; j<n-2; j+=4)
				{
				kernel_dgemm_nn_8x4_vs_lib4(m-i, n-j, k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[i*bs+j*sdc], sdc, &pD[i*bs+j*sdd], sdd, alg, 1, 1);
				}
			if(j<n)
				{
				kernel_dgemm_nn_8x2_vs_lib4(m-i, n-j, k, &pA[i*sda], sda, &pB[j*bs], sdb, &pC[i*bs+j*sdc], sdc, &pD[i*bs+j*sdd], sdd, alg, 1, 1);
			...
			for(; j<n-2; j+=4)
				{
				kernel_dgemm_nn_4x4_vs_lib4(m-i, n-j, k, &pA[i*sda], &pB[j*bs], sdb, &pC[i*bs+j*sdc], &pD[i*bs+j*sdd], alg, 1, 1);
				}
			if(j<n)
				{
				kernel_dgemm_nn_4x2_vs_lib4(m-i, n-j, k, &pA[i*sda], &pB[j*bs], sdb, &pC[i*bs+j*sdc], &pD[i*bs+j*sdd], alg, 1, 1);
				}
			return;
...
#if defined(TARGET_X64_AVX2) || defined(TARGET_X64_AVX) || defined(TARGET_X64_SSE3) || defined(TARGET_C99_4X4)
		...
		if(j<i) // dtrsm
			...
			if(j<n-2)
				...
				if(j<n-6)
					{
					//kernel_dsyrk_nt_4x4_lib4(k, &pA[(i+4)*sda], &pB[(j+4)*sdb], &pC[(j+4)*bs+(i+4)*sdc], &pD[(j+4)*bs+(i+4)*sdd], alg);
					kernel_dsyrk_dpotrf_nt_4x4_vs_lib4(m-i, n-j, 0, 0, j+4, dummy, dummy, &pC[(i+4)*sdc], &pC[(j+4)*sdc], &pD[(j+4)*bs+(i+4)*sdd], &pC[(j+4)*bs+(i+4)*sdc], fact, 1, 0);
					diag[j+4] = fact[0];
					diag[j+5] = fact[2];
					diag[j+6] = fact[5];
					diag[j+7] = fact[9];
				...
				if(fact[0]==0.0) fact[0]=1.0;
				if(fact[2]==0.0) fact[2]=1.0;
				kernel_dgemm_dtrsm_nt_4x2_vs_lib4(m-i, n-j, 0, 0, j, dummy, dummy, &pC[(i+4)*sdc], &pC[j*sdc], &pD[j*bs+(i+4)*sdd], &pC[j*bs+(i+4)*sdc], fact, 1);
				}
			}
		}
#endif
	for(; i<m; i+=4)
		...
		if(j<i) // dtrsm
			...
			if(j<n)
				...
				fact[2] = diag[j+1]; if(fact[0]==0.0) fact[2]=1.0;
				//kernel_dgemm_nt_4x2_lib4(k, &pA[i*sda], &pB[j*sdb], &pC[j*bs+i*sdc], &pD[j*bs+i*sdd], alg, 0, 0);
				kernel_dgemm_dtrsm_nt_4x2_vs_lib4(m-i, n-j, 0, 0, j, dummy, dummy, &pC[i*sdc], &pC[j*sdc], &pD[j*bs+i*sdd], &pC[j*bs+i*sdc], fact, 1);
				j += 2;
				}
			}
		else // dpotrf
			...
			if(j<n-2)
				{
				//kernel_dsyrk_nt_4x4_lib4(k, &pA[i*sda], &pB[j*sdb], &pC[j*bs+i*sdc], &pD[j*bs+i*sdd], alg);
				kernel_dsyrk_dpotrf_nt_4x4_vs_lib4(m-i, n-j, 0, 0, j, dummy, dummy, &pC[i*sdc], &pC[j*sdc], &pD[j*bs+i*sdd], &pC[j*bs+i*sdc], fact, 1, 0);
				diag[j+0] = fact[0];
				diag[j+1] = fact[2];
				diag[j+2] = fact[5];
				diag[j+3] = fact[9];
...
//			if(fact[2]==0.0) fact[2]=1.0;
			...
			for(; i<m; i+=2)
				{
				kernel_dgemm_dtrsm_nt_2x2_vs_lib4(m-i, n-j, 0, 0, j, dummy, dummy, &pC[i*sdc], &pC[j*sdc], &pD[j*bs+i*sdd], &pC[j*bs+i*sdc], fact, 1);
				}
			}
		else //if(i<m)
			{
			kernel_dsyrk_dpotrf_nt_2x2_vs_lib4(m-i, n-j, 0, 0, j, dummy, dummy, &pC[i*sdc], &pC[j*sdc], &pD[j*bs+i*sdd], &pC[j*bs+i*sdc], fact, 1, 0);
			diag[j+0] = fact[0];
			diag[j+1] = fact[2];
//			if(fact[0]==0.0) fact[0]=1.0;
//			if(fact[2]==0.0) fact[2]=1.0;
...
/*	int n = m;*/
	...
	for(; i<m-8; i+=12)
		...
		if(j<i) // dtrsm
			...
			if(j<n-2)
				{
				//kernel_dsyrk_nt_12x4_lib4(k, &pA[i*sda], sda, &pB[j*sdb], &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, alg);
				//kernel_dsyrk_dpotrf_nt_12x4_vs_lib4(m-i, n-j, 0, 0, j, dummy, 0, dummy, &pC[i*sdc], sdc, &pC[j*sdc], &pD[j*bs+i*sdd], sdd, &pC[j*bs+i*sdc], sdc, fact, 1, fast_rsqrt);
				kernel_dsyrk_dpotrf_nt_12x4_vs_lib4(m-i, n-j, 0, k, j, &pA[i*sda], sda, &pA[j*sda], &pD[i*sdd], sdd, &pD[j*sdd], &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, fact, alg, fast_rsqrt);
				diag[j+0] = fact[0];
				diag[j+1] = fact[2];
				diag[j+2] = fact[5];
				diag[j+3] = fact[9];
				if(j<n-10)
					{
					kernel_dsyrk_dpotrf_nt_8x8_vs_lib4(m-i, n-j, 0, k, j+4, &pA[(i+4)*sda], sda, &pA[(j+4)*sda], sda, &pD[(i+4)*sdd], sdd, &pD[(j+4)*sdd], sdd, &pC[(j+4)*bs+(i+4)*sdc], sdc, &pD[(j+4)*bs+(i+4)*sdd], sdd, fact, 1, fast_rsqrt);
					diag[j+4] = fact[0];
					diag[j+5] = fact[2];
					diag[j+6] = fact[5];
					diag[j+7] = fact[9];
					...
					{
					//kernel_dsyrk_nt_8x4_lib4(k, &pA[(i+4)*sda], sda, &pB[(j+4)*sdb], &pC[(j+4)*bs+(i+4)*sdc], sdc, &pD[(j+4)*bs+(i+4)*sdd], sdd, alg);
					kernel_dsyrk_dpotrf_nt_8x4_vs_lib4(m-i, n-j, 0, k, j+4, &pA[(i+4)*sda], sda, &pA[(j+4)*sda], &pD[(i+4)*sdd], sdd, &pD[(j+4)*sdd], &pC[(j+4)*bs+(i+4)*sdc], sdc, &pD[(j+4)*bs+(i+4)*sdd], sdd, fact, 1, fast_rsqrt);
					diag[j+4] = fact[0];
					diag[j+5] = fact[2];
					diag[j+6] = fact[5];
					diag[j+7] = fact[9];
					...
					//	{
					//	//kernel_dsyrk_nt_4x4_lib4(k, &pA[(i+8)*sda], &pB[(j+8)*sdb], &pC[(j+8)*bs+(i+8)*sdc], &pD[(j+8)*bs+(i+8)*sdd], alg);
					//	kernel_dsyrk_dpotrf_nt_4x4_vs_lib4(m-i, n-j, 0, 0, j+8, dummy, dummy, &pC[(i+8)*sdc], &pC[(j+8)*sdc], &pD[(j+8)*bs+(i+8)*sdd], &pC[(j+8)*bs+(i+8)*sdc], fact, 1, fast_rsqrt);
					//	diag[j+8] = fact[0];
					//	diag[j+9] = fact[2];
					//	diag[j+10] = fact[5];
					//	diag[j+11] = fact[9];
					...
					{
					//kernel_dsyrk_nt_8x2_lib4(k, &pA[(i+4)*sda], sda, &pB[(j+4)*sdb], &pC[(j+4)*bs+(i+4)*sdc], sdc, &pD[(j+4)*bs+(i+4)*sdd], sdd, alg);
					kernel_dsyrk_dpotrf_nt_4x2_vs_lib4(m-i, n-j, 0, k, j+4, &pA[(i+4)*sda], &pA[(j+4)*sda], &pD[(i+4)*sdd], &pD[(j+4)*sdd], &pC[(j+4)*bs+(i+4)*sdc], &pD[(j+4)*bs+(i+4)*sdd], fact, 1, fast_rsqrt);
					diag[j+4] = fact[0];
					diag[j+5] = fact[2];
					if(fact[0]==0.0) fact[0]=1.0;
					if(fact[2]==0.0) fact[2]=1.0;
				...
				{
				//kernel_dsyrk_nt_4x2_lib4(k, &pA[i*sda], &pB[j*sdb], &pC[j*bs+i*sdc], &pD[j*bs+i*sdd], alg);
				kernel_dsyrk_dpotrf_nt_4x2_vs_lib4(m-i, n-j, 0, k, j, &pA[i*sda], &pA[j*sda], &pD[i*sdd], &pD[j*sdd], &pC[j*bs+i*sdc], &pD[j*bs+i*sdd], fact, 1, fast_rsqrt);
				diag[j+0] = fact[0];
				diag[j+1] = fact[2];
				if(fact[0]==0.0) fact[0]=1.0;
				if(fact[2]==0.0) fact[2]=1.0;
	...
	for(; i<m-4; i+=8)
		...
		if(j<i) // dtrsm
			...
			if(j<n-6)
				{
				kernel_dsyrk_dpotrf_nt_8x8_vs_lib4(m-i, n-j, 0, k, j, &pA[i*sda], sda, &pA[j*sda], sda, &pD[i*sdc], sdd, &pD[j*sdd], sdd, &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, fact, 1, fast_rsqrt);
				diag[j+0] = fact[0];
				diag[j+1] = fact[2];
				diag[j+2] = fact[5];
				diag[j+3] = fact[9];
				...
				{
				//kernel_dsyrk_nt_8x4_lib4(k, &pA[i*sda], sda, &pB[j*sdb], &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, alg);
				kernel_dsyrk_dpotrf_nt_8x4_vs_lib4(m-i, n-j, 0, k, j, &pA[i*sda], sda, &pA[j*sda], &pD[i*sdc], sdd, &pD[j*sdd], &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, fact, 1, fast_rsqrt);
				diag[j+0] = fact[0];
				diag[j+1] = fact[2];
				diag[j+2] = fact[5];
				diag[j+3] = fact[9];
				...
				//	{
				//	//kernel_dsyrk_nt_4x4_lib4(k, &pA[(i+4)*sda], &pB[(j+4)*sdb], &pC[(j+4)*bs+(i+4)*sdc], &pD[(j+4)*bs+(i+4)*sdd], alg);
				//	kernel_dsyrk_dpotrf_nt_4x4_vs_lib4(m-i, n-j, 0, k, j+4, &pA[(i+4)*sda], &pA[(j+4)*sda], &pD[(i+4)*sdd], &pD[(j+4)*sdd], &pC[(j+4)*bs+(i+4)*sdc], &pD[(j+4)*bs+(i+4)*sdd], fact, 1, fast_rsqrt);
				//	diag[j+4] = fact[0];
				//	diag[j+5] = fact[2];
				//	diag[j+6] = fact[5];
				//	diag[j+7] = fact[9];
	...
	for(; i<m; i+=4)
		...
		if(j<i) // dtrsm
			...
			if(j<n-2)
				{
				//kernel_dsyrk_nt_4x4_lib4(k, &pA[i*sda], &pB[j*sdb], &pC[j*bs+i*sdc], &pD[j*bs+i*sdd], alg);
				kernel_dsyrk_dpotrf_nt_4x4_vs_lib4(m-i, n-j, 0, k, j, &pA[i*sda], &pA[j*sda], &pD[i*sdd], &pD[j*sdd], &pC[j*bs+i*sdc], &pD[j*bs+i*sdd], fact, 1, fast_rsqrt);
				diag[j+0] = fact[0];
				diag[j+1] = fact[2];
				diag[j+2] = fact[5];
				diag[j+3] = fact[9];
	...
	for( ; j<n-3; j+=4)
		{
		i = j;
//		if(m-i<=12) // dpotrf vs only
		if(m-i<=10) // dpotrf vs only
			{
			if(m-i<=6)
				{
				if(m-i<=4)
					{
					kernel_dsyrk_dpotrf_nt_4x4_vs_lib4(m-i, n-j, 0, k, j, &pA[i*sda], &pA[j*sda], &pD[i*sdd], &pD[j*sdd], &pC[j*bs+i*sdc], &pD[j*bs+i*sdd], fact, alg, fast_rsqrt);
					diag[j+0] = fact[0]; //==0.0 ? 1.0 : fact[0];
					diag[j+1] = fact[2]; //==0.0 ? 1.0 : fact[2];
					diag[j+2] = fact[5]; //==0.0 ? 1.0 : fact[5];
					diag[j+3] = fact[9]; //==0.0 ? 1.0 : fact[9];
					}
				else
					{
					kernel_dsyrk_dpotrf_nt_6x4_vs_lib4(m-i, n-j, 0, k, j, &pA[i*sda], sda, &pA[j*sda], &pD[i*sdd], sdd, &pD[j*sdd], &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, fact, alg, fast_rsqrt);
					diag[j+0] = fact[0]; //==0.0 ? 1.0 : fact[0];
					diag[j+1] = fact[2]; //==0.0 ? 1.0 : fact[2];
					diag[j+2] = fact[5]; //==0.0 ? 1.0 : fact[5];
					diag[j+3] = fact[9]; //==0.0 ? 1.0 : fact[9];
				...
				if(m-i<=8)
					{
					kernel_dsyrk_dpotrf_nt_8x4_vs_lib4(m-i, n-j, 0, k, j, &pA[i*sda], sda, &pA[j*sda], &pD[i*sdd], sdd, &pD[j*sdd], &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, fact, alg, fast_rsqrt);
					diag[j+0] = fact[0]; //==0.0 ? 1.0 : fact[0];
					diag[j+1] = fact[2]; //==0.0 ? 1.0 : fact[2];
					diag[j+2] = fact[5]; //==0.0 ? 1.0 : fact[5];
					diag[j+3] = fact[9]; //==0.0 ? 1.0 : fact[9];
...
//					if(m-i<=10)
//						{
						kernel_dsyrk_dpotrf_nt_10x4_vs_lib4(m-i, n-j, 0, k, j, &pA[i*sda], sda, &pA[j*sda], &pD[i*sdd], sdd, &pD[j*sdd], &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, fact, alg, fast_rsqrt);
						diag[j+0] = fact[0]; //==0.0 ? 1.0 : fact[0];
						diag[j+1] = fact[2]; //==0.0 ? 1.0 : fact[2];
						diag[j+2] = fact[5]; //==0.0 ? 1.0 : fact[5];
						diag[j+3] = fact[9]; //==0.0 ? 1.0 : fact[9];
...
//						}
			...
			{
			kernel_dsyrk_dpotrf_nt_8x4_lib4(k, j, &pA[i*sda], sda, &pA[j*sda], &pD[i*sdd], sdd, &pD[j*sdd], &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, fact, alg, fast_rsqrt);
			diag[j+0] = fact[0]; //==0.0 ? 1.0 : fact[0];
			diag[j+1] = fact[2]; //==0.0 ? 1.0 : fact[2];
			diag[j+2] = fact[5]; //==0.0 ? 1.0 : fact[5];
			diag[j+3] = fact[9]; //==0.0 ? 1.0 : fact[9];
			...
			for( ; i<m-10; i+=8)
				{
				kernel_dgemm_dtrsm_nt_8x4_lib4(k, j, &pA[i*sda], sda, &pA[j*sda], &pD[i*sdd], sdd, &pD[j*sdd], &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, fact, alg);
				}
			if(m-i>0)
				{
				if(m-i<=6)
					...
					if(m-i<=4)
						{
						kernel_dgemm_dtrsm_nt_4x4_vs_lib4(m-i, n-j, 0, k, j, &pA[i*sda], &pA[j*sda], &pD[i*sdd], &pD[j*sdd], &pC[j*bs+i*sdc], &pD[j*bs+i*sdd], fact, alg);
						}
					else
						{
						kernel_dgemm_dtrsm_nt_6x4_vs_lib4(m-i, n-j, 0, k, j, &pA[i*sda], sda, &pA[j*sda], &pD[i*sdd], sdd, &pD[j*sdd], &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, fact, alg);
						}
					}
				else
					{
					if(m-i<=8)
						{
						kernel_dgemm_dtrsm_nt_8x4_vs_lib4(m-i, n-j, 0, k, j, &pA[i*sda], sda, &pA[j*sda], &pD[i*sdd], sdd, &pD[j*sdd], &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, fact, alg);
						}
					else
						{
						kernel_dgemm_dtrsm_nt_10x4_vs_lib4(m-i, n-j, 0, k, j, &pA[i*sda], sda, &pA[j*sda], &pD[i*sdd], sdd, &pD[j*sdd], &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, fact, alg);
						}
					}
				}
			}
		...
		if(n-j==3)
			...
			if(m-i<=4) // dpotrf vs only
				...
				if(m-i>0)
					...
					if(m-i<=2)
						{
						kernel_dgemm_dtrsm_nt_2x4_vs_lib4(m-i, n-j, 0, k, j, &pA[i*sda], &pA[j*sda], &pD[i*sdd], &pD[j*sdd], &pC[j*bs+i*sdc], &pD[j*bs+i*sdd], fact, alg);
						}
					else
						{
						kernel_dgemm_dtrsm_nt_4x4_vs_lib4(m-i, n-j, 0, k, j, &pA[i*sda], &pA[j*sda], &pD[i*sdd], &pD[j*sdd], &pC[j*bs+i*sdc], &pD[j*bs+i*sdd], fact, alg);
			...
			{
			i = j;
			if(m-i<=2) // dpotrf vs only
				{
				kernel_dsyrk_dpotrf_nt_2x2_vs_lib4(m-i, n-j, 0, k, j, &pA[i*sda], &pA[j*sda], &pD[i*sdd], &pD[j*sdd], &pC[j*bs+i*sdc], &pD[j*bs+i*sdd], fact, alg, fast_rsqrt);
				diag[j+0] = fact[0]; //==0.0 ? 1.0 : fact[0];
				diag[j+1] = fact[2]; //==0.0 ? 1.0 : fact[2];
				return;
				}
				...
				{
				kernel_dsyrk_dpotrf_nt_4x2_vs_lib4(m-i, n-j, 0, k, j, &pA[i*sda], &pA[j*sda], &pD[i*sdd], &pD[j*sdd], &pC[j*bs+i*sdc], &pD[j*bs+i*sdd], fact, alg, fast_rsqrt);
				diag[j+0] = fact[0]; //==0.0 ? 1.0 : fact[0];
				diag[j+1] = fact[2]; //==0.0 ? 1.0 : fact[2];
				i += 4;
				for( ; i<m-4; i+=8)
					{
					kernel_dgemm_dtrsm_nt_8x2_vs_lib4(m-i, n-j, 0, k, j, &pA[i*sda], sda, &pA[j*sda], &pD[i*sdd], sdd, &pD[j*sdd], &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, fact, alg);
					}
				if(m-i>0)
					{
					if(m-i<=2)
						{
						kernel_dgemm_dtrsm_nt_2x2_vs_lib4(m-i, n-j, 0, k, j, &pA[i*sda], &pA[j*sda], &pD[i*sdd], &pD[j*sdd], &pC[j*bs+i*sdc], &pD[j*bs+i*sdd], fact, alg);
						}
					else
						{
						kernel_dgemm_dtrsm_nt_4x2_vs_lib4(m-i, n-j, 0, k, j, &pA[i*sda], &pA[j*sda], &pD[i*sdd], &pD[j*sdd], &pC[j*bs+i*sdc], &pD[j*bs+i*sdd], fact, alg);
						}
					}
				}
			}
	...
	for(; j<n-2; j+=4)
		...
		if(i<m-8)
			...
			for(; i<m-8; i+=12)
				{
				kernel_dgemm_dtrsm_nt_12x4_vs_lib4(m-i, n-j, 0, k, j, &pA[i*sda], sda, &pA[j*sda], &pD[i*sdd], sdd, &pD[j*sdd], &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, fact, alg);
				}
			for(; i<m-4; i+=8)
				{
				kernel_dgemm_dtrsm_nt_8x4_vs_lib4(m-i, n-j, 0, k, j, &pA[i*sda], sda, &pA[j*sda], &pD[i*sdd], sdd, &pD[j*sdd], &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, fact, alg);
	...
	if(offA==offB)
		...
		if(mna>0)
			...
			if(m<mna) // mna<=3  ==>  m = { 1, 2 }
				...
				if(m==1)
					{
					kernel_add_align_panel_1_0_lib4(n, alpha, A+offA, B+offB);
					return;
					}
				else //if(m==2 && mna==3)
					{
					kernel_add_align_panel_2_0_lib4(n, alpha, A+offA, B+offB);
					return;
					}
				}
			if(mna==1)
				...
				{
				kernel_add_align_panel_3_0_lib4(n, alpha, A+offA, B+offB);
				A += 4*sda;
				B += 4*sdb;
				ii += 3;
				}
		...
		for(; ii<m-7; ii+=8)
			{
			kernel_add_align_panel_8_0_lib4(n, alpha, A, sda, B, sdb);
			A += 8*sda;
			B += 8*sdb;
			}
#endif
		for(; ii<m-3; ii+=4)
			{
			kernel_add_align_panel_4_0_lib4(n, alpha, A, B);
			A += 4*sda;
			B += 4*sdb;
			}
		// clean up at the end
		if(ii<m)
			{
			if(m-ii==1)
				kernel_add_align_panel_1_0_lib4(n, alpha, A, B);
			else if(m-ii==2)
				kernel_add_align_panel_2_0_lib4(n, alpha, A, B);
			else // if(m-ii==3)
				kernel_add_align_panel_3_0_lib4(n, alpha, A, B);
			}
		}
	// skip one element of A
	else if(offA==(offB+1)%bs)
		...
		if(mna>0)
			...
			if(mna==1)
				...
				{
				kernel_add_align_panel_2_3_lib4(n, alpha, A, sda, B+2);
				A += 4*sda;
				B += 4*sdb;
				ii += 2;
				}
				...
				{
				kernel_add_align_panel_3_2_lib4(n, alpha, A, sda, B+1);
				A += 4*sda;
				B += 4*sdb;
				ii += 3;
				}
		...
		for( ; ii<m-7; ii+=8)
			{
			kernel_add_align_panel_8_1_lib4(n, alpha, A, sda, B, sdb);
			A += 8*sda;
			B += 8*sdb;
			}
#endif
		for( ; ii<m-3; ii+=4)
			{
			kernel_add_align_panel_4_1_lib4(n, alpha, A, sda, B);
			A += 4*sda;
			B += 4*sdb;
			}
		// clean up at the end
		if(ii<m)
			{
			if(m-ii==1)
				kernel_add_align_panel_1_0_lib4(n, alpha, A+1, B);
			else if(m-ii==2)
				kernel_add_align_panel_2_0_lib4(n, alpha, A+1, B);
			else // if(m-ii==3)
				kernel_add_align_panel_3_0_lib4(n, alpha, A+1, B);
			}
		}
	// skip 2 elements of A
	else if(offA==(offB+2)%bs)
		...
		if(mna>0)
			...
			if(m<mna)
				...
				if(m==1)
					...
					{
					kernel_add_align_panel_2_3_lib4(n, alpha, A, sda, B+1);
					return;
					}
				}
			if(mna==1)
				{
				kernel_add_align_panel_1_0_lib4(n, alpha, A+1, B+3);
				// A += 4*sda;
				B += 4*sdb;
				ii += 1;
				}
				...
				{
				kernel_add_align_panel_2_0_lib4(n, alpha, A, B+2);
				// A += 4*sda;
				B += 4*sdb;
				ii += 2;
				}
				...
				{
				kernel_add_align_panel_3_3_lib4(n, alpha, A, sda, B+1);
				A += 4*sda;
				B += 4*sdb;
				ii += 3;
				}
		...
		for(; ii<m-7; ii+=8)
			{
			kernel_add_align_panel_8_2_lib4(n, alpha, A, sda, B, sdb);
			A += 8*sda;
			B += 8*sdb;
			}
#endif
		for(; ii<m-3; ii+=4)
			{
			kernel_add_align_panel_4_2_lib4(n, alpha, A, sda, B);
			A += 4*sda;
			B += 4*sdb;
			}
		// clean up at the end
		if(ii<m)
			{
			if(m-ii==1)
				kernel_add_align_panel_1_0_lib4(n, alpha, A+2, B);
			else if(m-ii==2)
				kernel_add_align_panel_2_0_lib4(n, alpha, A+2, B);
			else // if(m-ii==3)
				kernel_add_align_panel_3_2_lib4(n, alpha, A, sda, B);
			}
		}
	// skip 3 elements of A
	else // if(offA==(offB+3)%bs)
		...
		for(; ii<m-7; ii+=8)
			{
			kernel_add_align_panel_8_3_lib4(n, alpha, A, sda, B, sdb);
			A += 8*sda;
			B += 8*sdb;
			}
#endif
		for(; ii<m-3; ii+=4)
			{
			kernel_add_align_panel_4_3_lib4(n, alpha, A, sda, B);
			A += 4*sda;
			B += 4*sdb;
			}
		// clean up at the end
		if(ii<m)
			{
			if(m-ii==1)
				kernel_add_align_panel_1_0_lib4(n, alpha, A+3, B);
			else if(m-ii==2)
				kernel_add_align_panel_2_3_lib4(n, alpha, A, sda, B);
			else // if(m-ii==3)
				kernel_add_align_panel_3_3_lib4(n, alpha, A, sda, B);
			}
		}
...
/*	int n = m;*/
	...
	for(; j<n-2; j+=4)
		...
		if(i<m-4)
			{
			kernel_dsyrk_dpotrf_nt_12x4_vs_lib4(m-i, n-j, 0, k, j, &pA[i*sda], sda, &pA[j*sda], &pD[i*sdd], sdd, &pD[j*sdd], &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, fact, alg, 0);
			i += 12;
			...
			{
			kernel_dsyrk_dpotrf_nt_8x4_vs_lib4(m-i, n-j, 0, k, j, &pA[i*sda], sda, &pA[j*sda], &pD[i*sdd], sdd, &pD[j*sdd], &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, fact, alg, 0);
			i += 8;
			diag[j+0] = fact[0];
			diag[j+1] = fact[2];
			diag[j+2] = fact[5];
		...
		if(i<m-4)
			...
			i += 8;
#else
			kernel_dsyrk_dpotrf_nt_4x4_vs_lib4(m-i, n-j, 0, k, j, &pA[i*sda], &pA[j*sda], &pD[i*sdd], &pD[j*sdd], &pC[j*bs+i*sdc], &pD[j*bs+i*sdd], fact, alg, 0);
			i += 4;
#endif
			diag[j+0] = fact[0];
			diag[j+1] = fact[2];
	...
	for(; j<n; j+=2)
		...
		if(i<m-2)
			{
			kernel_dsyrk_dpotrf_nt_4x2_vs_lib4(m-i, n-j, 0, k, j, &pA[i*sda], &pA[j*sda], &pD[i*sdd], &pD[j*sdd], &pC[j*bs+i*sdc], &pD[j*bs+i*sdd], fact, alg, 0);
			diag[j+0] = fact[0];
			diag[j+1] = fact[2];
			if(fact[0]==0.0) fact[0]=1.0;
			if(fact[2]==0.0) fact[2]=1.0;
			...
			{
			kernel_dsyrk_dpotrf_nt_2x2_vs_lib4(m-i, n-j, 0, k, j, &pA[i*sda], &pA[j*sda], &pD[i*sdd], &pD[j*sdd], &pC[j*bs+i*sdc], &pD[j*bs+i*sdd], fact, alg, 0);
			diag[j+0] = fact[0];
			diag[j+1] = fact[2];
			if(fact[0]==0.0) fact[0]=1.0;
			if(fact[2]==0.0) fact[2]=1.0;
...
/*	int n = m;*/
	...
	for(; j<n-2; j+=4)
		...
		if(i<m-8)
			...
			kernel_dsyrk_dpotrf_nt_12x4_vs_lib4(m-i, n-j, 1, k-i, j, &pA[i*sda+i*bs], sda, &pA[i*sda+i*bs], &pD[i*sdd], sdd, &pD[i*sdd], &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, fact, alg, 0);
			...
			for(; i<m-8 && i<k; i+=12)
				...
				kernel_dgemm_dtrsm_nt_12x4_vs_lib4(m-i, n-j, 1, k-i, j, &pA[i*sda+i*bs], sda, &pA[j*sda+i*bs], &pD[i*sdd], sdd, &pD[j*sdd], &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, fact, alg);
				//d_print_pmat(8, 4, bs, &pA[(k0+k+j)*bs+i*sda], sda);
				}
			for(; i<m-4 && i<k; i+=8)
				{
				...
				//d_print_pmat(8, k-i, bs, &pA[i*sda+i*bs], sda);
				//d_print_mat(k-i, 4, &pA[j*sda+i*bs], 4);
				kernel_dgemm_dtrsm_nt_8x4_vs_lib4(m-i, n-j, 1, k-i, j, &pA[i*sda+i*bs], sda, &pA[j*sda+i*bs], &pD[i*sdd], sdd, &pD[j*sdd], &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, fact, alg);
				//d_print_pmat(8, 4, bs, &pA[(k0+k+j)*bs+i*sda], sda);
				}
			for(; i<m-2 && i<k; i+=4)
				{
				...
				//d_print_mat(k-i, 4, &pA[j*sda+i*bs], 4);
				kernel_dgemm_dtrsm_nt_4x4_vs_lib4(m-i, n-j, 1, k-i, j, &pA[i*sda+i*bs], &pA[j*sda+i*bs], &pD[i*sdd], &pD[j*sdd], &pC[j*bs+i*sdc], &pD[j*bs+i*sdd], fact, alg);
			...
			for(; i<m && i<k; i+=2)
				{
				kernel_dgemm_dtrsm_nt_2x4_vs_lib4(m-i, n-j, 1, k-i, j, &pA[i*sda+i*bs], &pA[j*sda+i*bs], &pD[i*sdd], &pD[j*sdd], &pC[j*bs+i*sdc], &pD[j*bs+i*sdd], fact, alg);
				}
			for(; i<m-8; i+=12)
				{
				//d_print_pmat(8, k-i, bs, &pA[i*sda+i*bs], sda);
				kernel_dgemm_dtrsm_nt_12x4_vs_lib4(m-i, n-j, 0, 0, j, dummy, 0, dummy, &pD[i*sdd], sdd, &pD[j*sdd], &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, fact, alg);
				//d_print_pmat(8, 4, bs, &pA[(k0+k+j)*bs+i*sda], sda);
				}
			for(; i<m-4; i+=8)
				{
				//d_print_pmat(8, k-i, bs, &pA[i*sda+i*bs], sda);
				kernel_dgemm_dtrsm_nt_8x4_vs_lib4(m-i, n-j, 0, 0, j, dummy, 0, dummy, &pD[i*sdd], sdd, &pD[j*sdd], &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, fact, alg);
				//d_print_pmat(8, 4, bs, &pA[(k0+k+j)*bs+i*sda], sda);
				}
			for(; i<m-2; i+=4)
				{
				kernel_dgemm_dtrsm_nt_4x4_vs_lib4(m-i, n-j, 0, 0, j, dummy, dummy, &pD[i*sdd], &pD[j*sdd], &pC[j*bs+i*sdc], &pD[j*bs+i*sdd], fact, alg);
				//d_print_mat(4, 4, &pA[(k0+k+j)*bs+i*sda], 4);
				}
			for(; i<m; i+=2)
				{
				kernel_dgemm_dtrsm_nt_2x4_vs_lib4(m-i, n-j, 0, 0, j, dummy, dummy, &pD[i*sdd], &pD[j*sdd], &pC[j*bs+i*sdc], &pD[j*bs+i*sdd], fact, alg);
				}
			}		
		else if(i<m-4)
			{
			kernel_dsyrk_dpotrf_nt_8x4_vs_lib4(m-i, n-j, 1, k-i, j, &pA[i*sda+i*bs], sda, &pA[i*sda+i*bs], &pD[i*sdd], sdd, &pD[i*sdd], &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, fact, alg, 0);
			i += 8;
			diag[j+0] = fact[0];
			diag[j+1] = fact[2];
			diag[j+2] = fact[5];
		...
		if(i<m-4)
			...
			i += 8;
#else
			kernel_dsyrk_dpotrf_nt_4x4_vs_lib4(m-i, n-j, 1, k-i, j, &pA[i*sda+i*bs], &pA[i*sda+i*bs], &pD[i*sdd], &pD[i*sdd], &pC[j*bs+i*sdc], &pD[j*bs+i*sdd], fact, alg, 0);
	...
	for(; j<n; j+=2)
		...
		if(i<m-2)
			{
			kernel_dsyrk_dpotrf_nt_4x2_vs_lib4(m-i, n-j, 1, k-i, j, &pA[i*sda+i*bs], &pA[i*sda+i*bs], &pD[i*sdd], &pD[i*sdd], &pC[j*bs+i*sdc], &pD[j*bs+i*sdd], fact, alg, 0);
			diag[j+0] = fact[0];
			diag[j+1] = fact[2];
			if(fact[0]==0.0) fact[0]=1.0;
			if(fact[2]==0.0) fact[2]=1.0;
			...
			for(; i<m-4 && i<k; i+=8)
				{
				kernel_dgemm_dtrsm_nt_8x2_vs_lib4(m-i, n-j, 1, k-i, j, &pA[i*sda+i*bs], sda, &pA[j*sda+i*bs], &pD[i*sdd], sdd, &pD[j*sdd], &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, fact, alg);
				//d_print_pmat(8, 2, bs, &pA[(k0+k+j)*bs+i*sda], sda);
				}
#endif
			for(; i<m-2 && i<k; i+=4)
				{
				kernel_dgemm_dtrsm_nt_4x2_vs_lib4(m-i, n-j, 1, k-i, j, &pA[i*sda+i*bs], &pA[j*sda+i*bs], &pD[i*sdd], &pD[j*sdd], &pC[j*bs+i*sdc], &pD[j*bs+i*sdd], fact, alg);
				//d_print_mat(4, 2, &pA[(k0+k+j)*bs+i*sda], 4);
				}
			for(; i<m && i<k; i+=2)
				{
				kernel_dgemm_dtrsm_nt_2x2_vs_lib4(m-i, n-j, 1, k-i, j, &pA[i*sda+i*bs], &pA[j*sda+i*bs], &pD[i*sdd], &pD[j*sdd], &pC[j*bs+i*sdc], &pD[j*bs+i*sdd], fact, alg);
				}
#if defined(TARGET_X64_AVX) || defined(TARGET_X64_AVX2)
			for(; i<m-4; i+=8)
				{
				kernel_dgemm_dtrsm_nt_8x2_vs_lib4(m-i, n-j, 0, 0, j, dummy, 0, dummy, &pD[i*sdd], sdd, &pD[j*sdd], &pC[j*bs+i*sdc], sdc, &pD[j*bs+i*sdd], sdd, fact, alg);
				//d_print_pmat(8, 2, bs, &pA[(k0+k+j)*bs+i*sda], sda);
				}
#endif
			for(; i<m-2; i+=4)
				{
				kernel_dgemm_dtrsm_nt_4x2_vs_lib4(m-i, n-j, 0, 0, j, dummy, dummy, &pD[i*sdd], &pD[j*sdd], &pC[j*bs+i*sdc], &pD[j*bs+i*sdd], fact, alg);
				//d_print_mat(4, 2, &pA[(k0+k+j)*bs+i*sda], 4);
				}
			for(; i<m; i+=2)
				{
				kernel_dgemm_dtrsm_nt_2x2_vs_lib4(m-i, n-j, 0, 0, j, dummy, dummy, &pD[i*sdd], &pD[j*sdd], &pC[j*bs+i*sdc], &pD[j*bs+i*sdd], fact, alg);
				}
			}
		else //if(i<m)
			{
			kernel_dsyrk_dpotrf_nt_2x2_vs_lib4(m-i, n-j, 1, k-i, j, &pA[i*sda+i*bs], &pA[i*sda+i*bs], &pD[i*sdd], &pD[i*sdd], &pC[j*bs+i*sdc], &pD[j*bs+i*sdd], fact, alg, 0);
			diag[j+0] = fact[0];
			diag[j+1] = fact[2];
			if(fact[0]==0.0) fact[0]=1.0;
			if(fact[2]==0.0) fact[2]=1.0;
