...
void kernel_dpotrf_nt_4x4_lib4_new(int ksub, double *Am0, double *Bm, int alg, double *C0, int use_diag_C, double *diag_C, double *D0, double *inv_diag_D);
...
void kernel_dsyrk_dpotrf_nt_4x4_lib4_new(int kadd, double *Ap0, double *Bp, int ksub, double *Am0, double *Bm, int alg, double *C0, int use_diag_C, double *diag_C, double *D0, double *inv_diag_D);
