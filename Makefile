...
KERNEL_OBJS_DOUBLE = ./kernel/avx2/kernel_dgemm_avx2_lib4.o ./kernel/avx2/kernel_dtrmm_avx_lib4.o ./kernel/avx2/kernel_dtrsm_avx_lib4.o ./kernel/avx2/kernel_dgemm_dtrsm_avx_lib4.o ./kernel/avx2/kernel_dsyrk_avx_lib4.o ./kernel/avx2/kernel_dpotrf_avx_lib4.o ./kernel/avx2/kernel_dsyrk_dpotrf_avx_lib4.o ./kernel/avx2/kernel_dgemv_avx_lib4.o ./kernel/avx2/kernel_dtrmv_avx_lib4.o ./kernel/avx2/kernel_dtrsv_avx_lib4.o ./kernel/avx2/kernel_dsymv_avx_lib4.o ./kernel/avx2/kernel_dtran_avx_lib4.o 
