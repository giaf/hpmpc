...
void kernel_spotrf_pp_nt_8x4_lib4(int kadd, int ksub, float *A0, float *A1, float *B, float *C0, float *C1, float *D0, float *D1, int ldc_dummy, float *fact)
	{
...
void kernel_spotrf_pp_nt_4x4_lib4_old(int kadd, int ksub, float *A, float *B, float *C, float *D, int ldc, float *fact)
	{
