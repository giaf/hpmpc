...
void kernel_dsyrk_dpotrf_nt_4x4_vs_lib4(int km, int kn, int tri, int kadd, int ksub, double *A, double *B, double *C, double *D, double *fact, int alg)
	{
...
void kernel_dsyrk_dpotrf_nt_4x2_vs_lib4(int km, int kn, int tri, int kadd, int ksub, double *A, double *B, double *C, double *D, double *fact, int alg)
	{
...
void kernel_dsyrk_dpotrf_nt_2x2_vs_lib4(int km, int kn, int tri, int kadd, int ksub, double *A, double *B, double *C, double *D, double *fact, int alg)
	{
